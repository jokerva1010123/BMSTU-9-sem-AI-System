...
def _replaceCountry(inputArr):
    countryArr = []
    countryDict = {"франция": "Франция", "французский": "Франция",
                   "италия": "Италия", "итальянский": "Италия", 
                   "немецкий": "Германия", "германия": "Германия","германский": "Германия", 
                   "испания": "Испания", "испанский": "Испания",
                   "сша": "США", "американский": "США"}
